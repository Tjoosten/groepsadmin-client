...
// Use the Drupal namespace to facilitate the fork.
    ...
    Drupal.tableDrag = function (table, tableSettings) {
        ...
        $('> tr.' + this.tableSettings.draggableClass + ', > tbody > tr.' + this.tableSettings.draggableClass, table).each(function () {
...
//            }
    ...
    Drupal.tableDrag.prototype.hideColumns = function () {
        ...
        //BST, 25/5/14
        $('.tabledrag-toggle-weight').css('display', 'none');
        // Change cookie.
        $.cookie('Drupal.tableDrag.showWeight', 0, {
            path:this.tableSettings.cookiePath,
            // The cookie expires in one year.
    ...
    Drupal.tableDrag.prototype.updateField = function (changedRow, group) {
        ...
        if (rowSettings !== undefined) { //BST, 18/5/2014: crashes if turning off parent-mechanism
